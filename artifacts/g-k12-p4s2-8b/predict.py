...
W=C[np.frombuffer(B,np.uint8,1090,513)].reshape(109,10)
g=np.random.default_rng(1)
R=g.standard_normal((12,48),dtype=np.float32)*48**-.5
t=g.standard_normal(12,dtype=np.float32)*0.1
def f(x):
 ...
 h=np.maximum(c@R.T-t,0).reshape(len(x),3,5,3,5,12)
