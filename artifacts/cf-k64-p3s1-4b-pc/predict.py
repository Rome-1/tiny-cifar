...
R=g.standard_normal((64,27),dtype=np.float32)*0.19245008972987526
...
def feats(x):
 ...
 h=np.maximum(c@R.T-t,0).reshape(n,30,30,64)
 return h.reshape(n,5,6,5,6,64).mean((2,4)).reshape(n,-1)
def predict(x):
