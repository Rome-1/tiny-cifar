...
W=C[(np.unpackbits(np.frombuffer(B,np.uint8,1764,40),bitorder="little")[:14112].reshape(-1,3).astype(np.uint32)<<np.arange(3,dtype=np.uint32)).sum(1)].reshape(392,12)
def predict(x):
