...
b=3;k=8;c=[64,128,256,384];o=257
M=np.maximum
C=np.frombuffer(B,np.float16,16*k,1).astype(np.float32).reshape(16,k)
S=np.frombuffer(B,np.float16,853,o).astype(np.float32)
q=(np.unpackbits(np.frombuffer(B,np.uint8,56308,1963),bitorder="little")[:450462].reshape(-1,3).astype(np.uint32)<<np.arange(3,dtype=np.uint32)).sum(1)
