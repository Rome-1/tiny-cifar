...
b=3;k=8;c=[48,96,192,256];o=257
M=np.maximum
C=np.frombuffer(B,np.float16,16*k,1).astype(np.float32).reshape(16,k)
S=np.frombuffer(B,np.float16,613,o).astype(np.float32)
q=(np.unpackbits(np.frombuffer(B,np.uint8,30004,1483),bitorder="little")[:240030].reshape(-1,3).astype(np.uint32)<<np.arange(3,dtype=np.uint32)).sum(1)
